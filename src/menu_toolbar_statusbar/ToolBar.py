...
class Toolbar(QMainWindow) :
    ...
    def initUI(self):
        ...
        new = QAction(QIcon('./images/1.png'),"new",self)
        tb1.addAction(new)

        open = QAction(QIcon('./images/1.png'),"open",self)
        tb1.addAction(open)

        save = QAction(QIcon('./images/1.png'),"save",self)
        tb1.addAction(save)


        tb2 = self.addToolBar("File1")
        new1 = QAction(QIcon('./images/1.png'),"新建",self)
        tb2.addAction(new1)
